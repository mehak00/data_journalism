...
I also realized it was important to distinguish between which options were treatments and which were vaccines. Since a lot of treatments are based on existing, pre-approved medications, and because vaccines and treatments have fundamentally different uses - the former being pre-emptive, the latter being responsive, it was interesting to look at the breakdown. While a treatment can help those already affected and aid a global response to the pandemic, a vaccine is what we really need to return to "normal" life. 

<iframe title="Treatments vs. Vaccines " aria-label="Stacked Bars" id="datawrapper-chart-puXIe" src="https://datawrapper.dwcdn.net/puXIe/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="675"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}}))}();
</script>
